...
class DefaultAside extends Component {
  ...
  constructor(props) {
    ...
    this.switch_changed = this.switch_changed.bind(this);
    this.state = {
      activeTab: '1',
      switchState: true
    };
  ...
  render() {
    ...
    const displayState = this.state.switchState;
      ...
      <React.Fragment>
        ...
        <TabContent activeTab={this.state.activeTab}>
          ...
          <TabPane tabId="4" className="p-4">
            ...
            <br />
            <AppSwitch className={'mx-1'} color={'warning'} checked onClick={this.switch_changed}  />
            <div>
